...
## 경계
권위는 CLAUDE.md §문서 구조·§Verify Ownership과 `skills/implement/SKILL.md`다. 설계 문서(spec/analysis/implement.md)·체크박스·README 모두 수정 금지이며, 설계 변경이 필요해 보이면 작업을 멈추고 main에 보고한다.
