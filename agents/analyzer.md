...
- 미매핑 SPEC §5 criteria가 있으면 implement.md를 저장하지 않고 결정을 위임한다 (아래 결정 위임).
...
- Mode 2 trigger: 미매핑 SPEC §5 criteria 발견 시. 각 미매핑 항목에 대해 사용자 선택지 3가지(새 Task 추가 / SPEC §5 제거 / Exclusion 보류)를 묶어 main에 반환.
