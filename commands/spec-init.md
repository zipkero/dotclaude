...
### 승인 전 확인
- 기본은 생략이다. 사용자가 SPEC 승인 전에 답해야 할 feature 고유의 판단 질문을 만들 수 있을 때만 이 섹션을 둔다.
- 어느 feature에나 성립하는 일반 확인 질문("범위가 의도와 맞는지 확인" 류)은 두지 않는다. 고유 질문이 없으면 빈 섹션이나 보일러플레이트 대신 섹션을 생략한다.
