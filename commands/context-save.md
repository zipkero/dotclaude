...
2. 현재 대화에서 확인된 목표, 결정, 아직 정해지지 않은 판단과 다음 작업을 추린다.
...
- `미확정 판단`에는 다음 결과를 실제로 바꿀 선택지만 적고,
  항목마다 사용자와 논의된 쟁점인지 문서 작성 과정에서 제안된 미논의 후보인지 출처를 함께 적는다.
  미논의 후보도 논의가 필요하면 남기되, 사용자와 이미 논의한 것처럼 표현하지 않고
  후보가 적힌 문서 위치를 링크한다.
